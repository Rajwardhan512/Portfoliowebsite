...
import { ExternalLink, Github, Eye, Bot, Heart, Video, Film } from 'lucide-react';
...
const ProjectsSection: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Python', 'TensorFlow', 'Scikit-learn', 'Flask', 'Bootstrap', 'SQLite'],
      githubUrl: 'https://github.com/Rajwardhan512/food-label-analyzer',
      featured: true,
      color: '#02569b'
    },
    {
    ...
    },
    {
      ...
      technologies: ['Python', 'scikit-learn', 'Pandas', 'Streamlit', 'APIs', 'Data Analysis'],
      githubUrl: 'https://github.com/Rajwardhan512/mernbot',
      featured: false,
      color: '#4ecdc4'
    }
  ];
